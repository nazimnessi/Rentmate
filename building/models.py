...
class Request(models.Model):
    ...
    receiver = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="recieved_requests"
    )
...
class Building(models.Model):
    ...
    photo = models.ImageField(upload_to="images/", default="Default_user.png")
...
class Room(models.Model):
    ...
    room_type = models.CharField(max_length=10, choices=room_choice, default="House")
